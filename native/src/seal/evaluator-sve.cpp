            ...
            size_t count, const Modulus &modulus, bool do_reduce)
        {
            ...
            if (do_reduce)
            {
                ...
                for (; i < full; i += N)
                {
                    ...
                    svuint64_t prod_hi = svmulh_u64_x(ptrue, v_op, v_key);
                ...
                if (i < count)
                {
                    ...
                    svuint64_t prod_hi = svmulh_u64_x(pg, v_op, v_key);
                    ...
                    SEAL_ITERATE(iter(J, base_iter, shifted_out_iter), base_size, [&](auto K) {
#ifdef __ARM_FEATURE_SVE
                        {
                            ...
                            for (; k < full; k += N)
                            {
                                ...
                                svuint64_t z_hi = svmulh_u64_x(ptrue, a, b);
                            ...
                            if (k < coeff_count)
                            {
                                ...
                                svuint64_t z_hi = svmulh_u64_x(pg, a, b);
