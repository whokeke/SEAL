    ...
    namespace util
    {
            ...
            const uint64_t *operand1, const uint64_t *operand2, size_t count, const Modulus &modulus)
        {
            ...
            while (i + 4 * N <= count)
            {
                ...
                sve_add_u128(acc_lo, acc_hi, svmul_u64_x(svptrue_b64(), v1_0, v2_0), sve32_mulhi_u64(svptrue_b64(), v1_0, v2_0), svptrue_b64());

                svuint64_t v1_1 = svld1_u64(svptrue_b64(), operand1 + i + N);
                svuint64_t v2_1 = svld1_u64(svptrue_b64(), operand2 + i + N);
                sve_add_u128(acc_lo, acc_hi, svmul_u64_x(svptrue_b64(), v1_1, v2_1), sve32_mulhi_u64(svptrue_b64(), v1_1, v2_1), svptrue_b64());

                svuint64_t v1_2 = svld1_u64(svptrue_b64(), operand1 + i + 2 * N);
                svuint64_t v2_2 = svld1_u64(svptrue_b64(), operand2 + i + 2 * N);
                sve_add_u128(acc_lo, acc_hi, svmul_u64_x(svptrue_b64(), v1_2, v2_2), sve32_mulhi_u64(svptrue_b64(), v1_2, v2_2), svptrue_b64());

                svuint64_t v1_3 = svld1_u64(svptrue_b64(), operand1 + i + 3 * N);
                svuint64_t v2_3 = svld1_u64(svptrue_b64(), operand2 + i + 3 * N);
                sve_add_u128(acc_lo, acc_hi, svmul_u64_x(svptrue_b64(), v1_3, v2_3), sve32_mulhi_u64(svptrue_b64(), v1_3, v2_3), svptrue_b64());
            ...
            while (i + N <= count)
            {
                ...
                sve_add_u128(acc_lo, acc_hi, svmul_u64_x(svptrue_b64(), v1, v2), sve32_mulhi_u64(svptrue_b64(), v1, v2), svptrue_b64());
                i += N;
            }
            ...
            if (i < count)
            {
                ...
                sve_add_u128(acc_lo, acc_hi, svmul_u64_x(pg, v1, v2), sve32_mulhi_u64(pg, v1, v2), pg);
            }
