...
#define SEAL_MULTIPLY_UINT64(operand1, operand2, result128)                                  \
    do                                                                                        \
    {                                                                                         \
        unsigned __int128 _seal_prod =                                                       \
            (unsigned __int128)(operand1) * (unsigned __int128)(operand2);                   \
        (result128)[0] = (unsigned long long)_seal_prod;                                      \
        (result128)[1] = (unsigned long long)(_seal_prod >> 64);                             \
    } while (0)
#endif
#endif
...
#define SEAL_MULTIPLY_UINT64_HW64(operand1, operand2, hw64)                                  \
    ...
    {                                                                                         \
        unsigned __int128 _seal_prod =                                                       \
            (unsigned __int128)(operand1) * (unsigned __int128)(operand2);                   \
        *(hw64) = (unsigned long long)(_seal_prod >> 64);                                    \
    } while (0)
#endif
#endif
