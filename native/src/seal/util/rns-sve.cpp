                    ...
                    else
                    {
...
#ifdef __ARM_FEATURE_SVE
                        {
                            ...
                            while (j + N <= count)
                            {
                                ...
                                svuint64_t v_hi = svmulh_u64_x(svptrue_b64(), v_in, sv_inv_q);
                            ...
                            if (j < count)
                            {
                                ...
                                svuint64_t v_hi = svmulh_u64_x(pg, v_in, sv_inv_q);
            ...
            */
...
#ifdef __ARM_FEATURE_SVE
            {
                ...
                for (; j < full; j += N)
                {
                    ...
                    svuint64_t v_hi = svmulh_u64_x(ptrue, v_x, sv_inv_q);
                ...
                if (j < coeff_count_)
                {
                    ...
                    svuint64_t v_hi = svmulh_u64_x(pg, v_x, sv_inv_q);
            ...
            */
            ...
            for (size_t i = 0; i < base_Bsk_size; i++)
            {
                ...
                for (; j < full; j += N)
                {
                    ...
                    svuint64_t v_sum_hi = svmulh_u64_x(ptrue, v_sum, sv_inv_m_tilde_q);
                ...
                if (j < coeff_count_)
                {
                    ...
                    svuint64_t v_sum_hi = svmulh_u64_x(pg, v_sum, sv_inv_m_tilde_q);
