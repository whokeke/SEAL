// Benchmark: Lazy Barrett mulmod — AVX-512 intrinsic + scalar (no inline asm)
// Build: gcc -O3 -mavx512f -mavx512dq -D_GNU_SOURCE -o bench_mulmod_avx512_intrinsic bench_mulmod_avx512_intrinsic.c
// Run:   taskset -c 1 ./bench_mulmod_avx512_intrinsic
//
// Tests:
//   - scalar schoolbook (32-bit decomposition, ~16 instructions)
//   - scalar __uint128_t (compiler generates umulh on AArch64 / mul+umulh path)
//   - AVX-512 schoolbook (_mm512_mul_epu32 32x32->64 widening, 8 lanes/iter)
...
// ---- Scalar schoolbook (32-bit decomposition, no umulh) ----
...
int main() {
    ...
    printf("=== Lazy Barrett mulmod benchmark (AVX-512 intrinsic) ===\n");
    printf("    N=%d ITERS=%d\n\n", N_ELEMS, ITERS);
