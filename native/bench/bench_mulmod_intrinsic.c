// Benchmark: Lazy Barrett mulmod — SVE intrinsic + SVE32 + scalar
// Build: gcc -O3 -march=armv9-a+sve2 -D_GNU_SOURCE -o bench_mulmod_intrinsic bench_mulmod_intrinsic.c
// Run:   taskset -c 1 ./bench_mulmod_intrinsic
...
/* ---- SVE32 schoolbook mulhi (intrinsic) ---- */
